function ApprovePendingLegals(opts, callBackHandler) {
...
ApprovePendingLegals.prototype.findPendingLegals = function(apiId) {
	var selfObj = this;
	var inputData = {};
	if (selfObj.apiId) {
		inputData = {
...
ApprovePendingLegals.prototype.bindActions = function() {
	var selfObj = this;
...
ApprovePendingLegals.prototype.printOrSave = function(documentID, printOrSave) {
	$.ajax({
		type : 'GET',
