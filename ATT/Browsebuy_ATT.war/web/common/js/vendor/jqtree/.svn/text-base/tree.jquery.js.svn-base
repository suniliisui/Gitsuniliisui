  ...
  JqTreeWidget = (function(_super) {
      ...
      return $.ajax({
        ...
        success: function(response) {
          ...
          if(_this.options.parseData) {
        	  data = _this.options.parseData(data);
          }
    ...
    JqTreeWidget.prototype._refreshElements = function(from_node) {
      ...
      createNodeLi = function(node) {
		...
		/*var actionPanel="<span class='actionPanel'><span class='actionIcons alarmsAction'></span><span class='actionIcons ticketsAction'></span><span class='actionIcons ordersAction'></span><span class='actionIcons otherAction'></span></span>";*/
		var actionPanel="";/*commented the above line for future use*/
		if(node.endNode ==="endnode"){
			 return $("<li class=\"" + class_string + "\"><div id='"+ node.id +"' class=\"jqtree-element jqtree_common\"><div style='float: left; width: 50%;padding-left: 5px;'><div class= '"+ node.endNode  +"'></div><div  class=\"jqtree-title jqtree_common \">" + escaped_name + "</div><div class='endNodeSublabel'>"+ node.sublabel +"</div></div>"+actionPanel+"</div></div></li>");
		}
        return $("<li class=\"" + class_string + "\"><div id='"+ node.id +"' class=\"jqtree-element jqtree_common\"><div style='float: left; width: 50%;'><div class= '"+ node.endNode  +"'></div><div  class=\"jqtree-title jqtree_common \">" + escaped_name + "</div><div class='sublabel'>"+ node.sublabel +"</div></div>"+actionPanel+"</div></li>");
      ...
      createFolderLi = function(node) {
		...
		if(node.parentNode=="parentNode"){
			actionPanel="<span class='actionPanel'><input class='serviceID' type='hidden' value='"+ node.sublabel +"'/><span class='actionIcons alarmsAction' title='Alarms'></span><span class='actionIcons ticketsAction' title='Trouble Tickets'></span><span class='actionIcons ordersAction' title='Orders'></span><span class='actionIcons otherAction'  title='More'></span></span>";
		}
        return $("<li class=\"jqtree_common " + folder_classes + "\"><div class=\"jqtree-element jqtree_common\"><a style='float:left;' id='"+ node.id +"' class=\"jqtree_common " + button_classes + "\">" + button_char + "</a><span class=\"jqtree_common jqtree-title\">" + escaped_name + "</span>"+actionPanel+"</br><span class='sublabel'> "+ node.sublabel +" </span></span></li>");
      };
