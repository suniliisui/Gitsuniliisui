...
<%-- END BLOCK --%>
<title>AT&amp;T Small Business - Choose Your Internet Installation Type</title>

<%-- StartOf: Page Specific Styles (page_specific). Below CSS file is page specific --%>			  
<link rel="stylesheet" type="text/css"
	href="${contextPath}/web/css/chooseInstallationOptions.css" />
...
<%-- START BLOCK --%>
<body class="att-smb-bnb" data-controller="ChooseInstallationOptions" data-action="show">
...
<%-- END BLOCK --%>
	...
	<div class="solution-config clearfix">
		<div id="content-wpr" class="clearfix">
			...
			<div class="page-content-wpr" id="page-content-wpr">
					<div id="internet-installation-options-wpr" class="bui-screen-width bui-p-lr-10 clearfix">
						<%-- Backbone JS fills this space --%>
					</div>
			</div>
		</div>
	...
	<dsp:include page="${contextpath}/solution/buyflow/internet/_chooseInstallationOptionsTpl.jsp"/>
...
<c:if test="${not empty param.jsdebug}">
	...
	<script	src="${contextPath}/web/js/solution/buyflow/internet/chooseInstallationOptions${jsdebug}" type="text/javascript"></script>
	<script	src="${contextPath}/web/js/solution/buyflow/internet/model/installationOptionsModel${jsdebug}"	type="text/javascript"></script>
	<script	src="${contextPath}/web/js/solution/buyflow/internet/view/installationOptionsView${jsdebug}" type="text/javascript"></script>
