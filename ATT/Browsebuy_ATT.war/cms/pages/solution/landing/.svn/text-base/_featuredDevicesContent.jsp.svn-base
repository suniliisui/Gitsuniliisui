...
<dsp:page>
	...
	<dsp:importbean bean="/atg/dynamo/droplet/ForEach" />
		...
		<dsp:oparam name="output">
			...
			<div id="featured-devices-section-wpr" 
						class="content-wpr clearfix content clearfix">
						<div class="bui-screen-width clearfix">		

							<h4 id="section-insert"class="section-title">Save on best-selling tablets.</h4>
							<div class="featured-devices-note bui-m-t-20">
								<p class="">Shop
								 best-selling tablets now to find your perfect color, and
								 monthly data plan. <br />It&#39;s not complicated. You got this&#33;
								</p>
							</div>
