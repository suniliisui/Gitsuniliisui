	...
	<table width="90%" style="color: #656565; font: normal Verdana; text-align: center; margin-left: 20px">
		<tbody>
			...
			<tr valign="top" style="text-align: center">
				...
				<td style="padding: 5px; font: normal 12px Verdana; width:30%">We&#39;ll schedule around the preferences you supplied, and send an email with suggested date and time.</td>
