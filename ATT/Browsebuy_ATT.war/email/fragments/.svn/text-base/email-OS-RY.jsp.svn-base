	...
	<table width="90%" style="color: #656565; font: normal Verdana; text-align: center; margin-left: 20px">
		<tbody>
			...
			<tr valign="top" style="text-align: center">
				<td style="padding: 5px; font: normal 16px Verdana; width:45%">1.
					Order</td>
				<td style="padding: 5px; font: normal 16px Verdana; width:45%">2.
					Start Profiting</td>
			</tr>
			<tr valign="top" style="text-align: center">
				<td style="padding: 5px; font: normal 12px Verdana; width:45%">Order submitted</td>
				<td style="padding: 5px; font: normal 12px Verdana; width:45%">Start working more efficiently with your new products and services.</td>
			</tr>
		</tbody>
	</table>
